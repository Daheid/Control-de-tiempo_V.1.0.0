...
<form class="form" action="bbdd/formulario.php" name="" method="post">
    <div class="flex"></div>  
        ...
        <input class="input123" type="text" placeholder="Escribe tu Nombre" name="nombre" id="name_user" required> 

        <label for="lastname_user">Ingrese su Apellido</label>
        <input class="input123" type="text" placeholder="Escribe tu Apellido" name="apellido" id="lastname_user" required>

        <label for="cedula_user">Ingrese su Cedula</label>
        <input class="input123" type="text" placeholder="Escribe tu Cedula" name="cedula" id="cedula_user" required>
        ...
        <select  class="input123" type="text" placeholder="Ej: femenino o masculino" name="genero" id="genero" required> 
        ...
        <input class="input123" type="text" placeholder="Ej: 20" name="edad" id="edad" required>

        
        <input class="input123" type="time" name="hora" id="hora-sistema" readonly hidden >
        <input type="date" name="fecha" id="fecha" readonly hidden>
