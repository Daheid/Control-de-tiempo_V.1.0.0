...
class PDF extends FPDF
{
   ...
   function Header()
   {
      ...
      $this->Cell(30, 10, utf8_decode('CORREO'), 1, 0, 'C', 1);
      ...
      $this->Cell(25, 10, utf8_decode('OBSERVACION'), 1, 1, 'C', 1);
   }
...
$i = $i + 1;
/* TABLA */
$pdf->Cell(18, 10, utf8_decode('NOMBRE'), 1, 0, 'C', 0);
$pdf->Cell(20, 10, utf8_decode('APELLIDO'), 1, 0, 'C', 0);
$pdf->Cell(30, 10, utf8_decode('CEDULA'), 1, 0, 'C', 0);
$pdf->Cell(25, 10, utf8_decode('TELEFONO'), 1, 0, 'C', 0);
$pdf->Cell(70, 10, utf8_decode('CORREO'), 1, 0, 'C', 0);
$pdf->Cell(70, 10, utf8_decode('GENERO'), 1, 0, 'C', 0);
$pdf->Cell(70, 10, utf8_decode('EDAD'), 1, 0, 'C', 0);
$pdf->Cell(70, 10, utf8_decode('HORA'), 1, 0, 'C', 0);
$pdf->Cell(70, 10, utf8_decode('FECHA'), 1, 0, 'C', 0);
$pdf->Cell(25, 10, utf8_decode('OBSERVACION'), 1, 1, 'C', 0);
